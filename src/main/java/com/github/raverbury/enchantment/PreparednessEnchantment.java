...
public class PreparednessEnchantment extends UniqueChestplateEnchantment {

    public static final String ID = "preparedness";
    ...
    public PreparednessEnchantment() {
        super(Rarity.RARE);
    }
    ...
    public static void onLivingAttack(LivingAttackEvent event) {
        ...
        checkAndApplyPreparedness(entity);
        checkAndApplyPreparedness(attacker);
    }

    private static void checkAndApplyPreparedness(LivingEntity entity) {
        int preparednessLevel = EnchantmentHelper.getEnchantmentLevel(ModRegistries.PREPAREDNESS.get(), entity);
        ...
        int duration = BASE_DURATION + DURATION_GROWTH * preparednessLevel;
